...
export async function obtenerDiagrama(projectId: number): Promise<DiagramaResponse> {
  const response = await api.get<DiagramaResponse>(`/proyectos/${projectId}/diagrama`)
